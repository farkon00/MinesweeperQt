...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def init_ui(self) -> None:
        ...
        self.pro_mode_button = QtWidgets.QCheckBox("Pro Mode")
        self.pro_mode_button.setChecked(False)
        self.pro_mode_button.stateChanged.connect(self.state.pro_mode) # type: ignore
        self.level_layout.addWidget(self.pro_mode_button)
